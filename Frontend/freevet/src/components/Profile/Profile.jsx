...
function Profile({
  ...
  return (
    <div className="w-full max-w-5xl mx-auto flex flex-col gap-6 text-neutral-100 p-4">
      <div className="text-lg font-bold tracking-widest text-neutral-200 uppercase text-center">
        Profile
      </div>
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 p-6 bg-neutral-900 border border-neutral-800 rounded-2xl shadow-lg">
        <div className="flex items-center gap-4">
          {user.avatar_url ? (
            ...
            <div className="w-16 h-16 rounded-full bg-blue-900/50 border border-blue-700/30 flex items-center justify-center text-blue-400 select-none">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="p-8 bg-neutral-900 border border-neutral-800 rounded-2xl shadow-sm flex flex-col gap-4">
